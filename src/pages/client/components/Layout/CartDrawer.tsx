...
const CartDrawer = ({drawOpen, toggleCart}) => {
  ...
  return (
    <div className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-[30rem] h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${drawOpen?"translate-x-0":"translate-x-full"}`}>
