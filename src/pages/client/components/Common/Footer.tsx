    ...
    <footer className='border-t py-12'>
        <div className='container mx-auto grid grid-cols-4 gap-8 px-4 lg:px-0'>
            <div>
                ...
                <p className='text-gray-500 mb-4'>Be the first to hear new products and online offers.</p>
                <p className='font-medium text-sm text-gray-600 mb-6'>Sign up and get 10% off your first order</p>
                <form className='flex'>
                    <input type="email" placeholder='Enter your email' className='p-3 w-full text-sm border-t border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all' required/>
            ...
            <div>
                <h3 className='tetx-lg text-gray-800 mb-4'>Shop</h3>
            ...
            <div>
                <h3 className='tetx-lg text-gray-800 mb-4'>Support</h3>
                <ul className='space-y-2 text-gray-600'>
                    <li>
        ...
        <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
            <p className='text-gray-500 text-sm tracking-tighter text-center'>c 2025, CompileTab. All Rights Reserved</p>
        </div>
    </footer>
  )
}
