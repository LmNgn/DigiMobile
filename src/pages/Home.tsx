                    ...
                    {products.map((p, index) => (
                        <tr key={p.id}>
                            ...
                            <td>
                                ...
                                <Link className="btn btn-outline-primary" to={`/detail/${p.id}`}>
                                    <i className="fas fa-info-circle" />
                                </Link>
                                <Link className="btn btn-outline-warning" to={"/update/" + p.id}>
                                    <i className="fa-solid fa-gear" />
                                </Link>
                                <button className="btn btn-outline-danger" onClick={() => delPro(p.id)}>
